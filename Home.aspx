...
<head runat="server">
    ...
    <%-- Đường dẫn tới file CSS đã được cập nhật --%>
    ...
    <form id="form1" runat="server">
            ...
            <div class="container">
                <div class="header-content">
                    ...
                    <div class="header-icons">
                        ...
                        <a href="Login.aspx" class="icon-link">
        ...
        <main>
            <section class="hero-section">
                <img src="./assets/images/ssung.png" alt="Banner quảng cáo" class="hero-image">
                <div class="hero-content">
                    ...
                    <a href="DetailProduct.aspx" class="hero-button">Mua ngay</a>w
                </div>
            </section>
                    ...
                    <div class="product-grid">
                        <div class="product-card">
                            <div class="product-image-container">
                                <img src="./assets/images/cucGach.png" class="product-image" alt="iPhone 15">
                ...
                <div class="container">
                    ...
                    <div class="features-grid">
                        <div class="feature-card">
                            <img src="./assets/icons/rocket-lunch.png" alt="Miễn phí vận chuyển">
                            <h3>Giao hàng miễn phí</h3>
                            <p>Miễn phí giao hàng toàn quốc cho đơn từ 2 triệu đồng.</p>
                        </div>
                        <div class="feature-card">
                            <img src="./assets/icons/shield-check.png" alt="Bảo hành chính hãng">
                            <h3>Bảo hành chính hãng</h3>
                            <p>Cam kết 100% sản phẩm chính hãng, bảo hành minh bạch.</p>
                        </div>
                        <div class="feature-card">
                            <img src="./assets/icons/handshake.png" alt="Hỗ trợ 24/7">
                            <h3>Hỗ trợ 24/7</h3>
